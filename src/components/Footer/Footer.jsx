        ...
        <div className="footer-content">
          ...
          <div className="footer-content-right">
            ...
            <ul>
                ...
                <li>contact@thehungeradda.com</li>
                <li>Ghaziabad, Uttar Pradesh, IN - 201001</li>
            </ul>
          </div>
        </div>
        <hr />
        <p className="footer-copyright">
            Copyright 2024 @ tha.com - All Right Reserved.
        </p>
        <p>This project is purely for educational purposes, no real business transactions are involved. All food data is owned by The Hunger Adda Group.</p>
      </div>
    </>
  );
}
